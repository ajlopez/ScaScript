...
var rules = [
    ...
    // Var, Val Statements
    get('var', 'Name', 'Assign', 'Expression', 'SemiColon').generate('Statement', function (values) { return new VarStatement(values[1].getName(), values[3]); }),
    get('val', 'Name', 'Assign', 'Expression', 'SemiColon').generate('Statement', function (values) { return new ValStatement(values[1].getName(), values[3]); }),
